...
let
  ...
  inherit (lib.options)
    ...
    unknownModule
    ;
  inherit (lib.strings) isConvertibleWithToString levenshtein levenshteinAtMost;
    ...
    let
      ...
      doCollect =
        ...
        collectModules class (specialArgs.modulesPath or "") (regularModules ++ [ internalModule ]) (
          {
            inherit lib options specialArgs;
            _class = class;
            _prefix = prefix;
      ...
      (
        ...
        let
          ...
          addDeprecatedWrapped =
            ...
            // {
              functor = t.functor // {
                wrapped = t.functor.wrappedDeprecationMessage { inherit loc; };
              };
            };
